resource "aws_elastic_beanstalk_environment" "vpofile-bean-prod" {
  ...
  setting {
    namespace = "aws:ec2:vpc"
    name      = "Subnets"
    value     = join(",", [module.ksh-vpc.private_subnets[0], module.ksh-vpc.private_subnets[1], module.ksh-vpc.private_subnets[2]])
  }

  setting {
    namespace = "aws:ec2:vpc"
    name      = "ELBSubnets"
    value     = join(",", [module.ksh-vpc.public_subnets[0], module.ksh-vpc.public_subnets[1], module.ksh-vpc.public_subnets[2]])
  }
  ...
  setting {
    namespace = "aws:autoscaling:launchconfiguration"
    name      = "EC2KeyName"
    value     = aws_key_pair.aws-key.key_name
  }
